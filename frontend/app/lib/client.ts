// Code generated by the Encore v1.40.0 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-my-team-d2bi.encr.app`
}
...
/**
 * Client is an API client for the my-team-d2bi Encore application. 
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "my-team-d2bi-Generated-TS-Client (Encore/v1.40.0)";
        }
